...
The 12-month vendor ROI is **−92%** — expected, because the pilot client's subscription is waived in Phase 2 and the only income is the onboarding fee (€17,500 against €210,205 in costs). Revenue grows materially once clients 2 and 3 are signed in Phase 3: with three paying clients at the Growth tier midpoint (€75,000/year each), annual subscription revenue reaches €225,000 against ongoing costs of €133,010/year. On this basis vendor break-even occurs around **Month 30–36** — driven entirely by client acquisition speed, not by the client's own savings. Every additional paying client accelerates break-even because the ongoing cost base does not scale linearly with client count.

Two scenarios pull break-even earlier: if the pilot client converts to a full subscription from Month 7 (rather than having it waived), break-even moves to around Month 24; if a fourth or fifth client is signed in Year 2, the shared cost base drops further and margin builds faster.

This plan doesn't soften the investment picture. Year 1 is a cost year by design — the system isn't live and generating subscription revenue until Month 7, and the pilot client's subscription is waived as the price of the case study. The business case rests on three clients paying full subscriptions from Year 2 onward, with the cost base staying broadly flat as the client base grows.
...
|---|---|---|---|
| **Chief Commercial Officer** (primary sponsor) | The vendor ROI picture — 12-month ROI is −92% (investment year, pilot subscription waived); break-even at Month 30–36 with 3 paying clients at Growth tier; accelerates to Month 24 if pilot client converts to full subscription from Month 7. Revenue is driven by client acquisition speed, not the client's own savings. Pilot results to inform the Phase 3 go/no-go. | Project lead | Phase 1 kickoff; end of Phase 2 (pilot results); Phase 3 go-live decision |
...
In practice the model is a hybrid of the three pricing components above, not pure self-serve SaaS from day one: a real consulting/services component at onboarding (Phase 2's white-glove build and workshops), the recurring SaaS subscription as the long-term relationship from Phase 3 onward, and a licence option held in reserve for the subset of enterprise clients whose data-residency requirements rule out shared infrastructure. The vendor ROI break-even sits at Month 30–36 with three paying clients at the Growth tier — no single pilot client's first-year subscription covers the build cost, and the business case depends on the client base building across Phase 3 and Phase 4, not on Phase 2 alone being profitable.

---

*TermsIQ Strategic Deployment and Commercialisation Plan — Version 2.1 — June 2026*
*Cross-referenced against TermsIQ — ROI & Risk Assessment, Version 1.4 (corrected vendor ROI)*
